...
import com.lumigram.messenger.helpers.ApkInstaller;
...
public class UpdateLayout extends IUpdateLayout {
    ...
    public void createUpdateUI(int currentAccount) {
        ...
        updateTextView.setText(LocaleController.getString(R.string.UpdateLumigram), false);
        ...
        if (SharedConfig.isAppUpdateAvailable()) {
            ...
            if (path.exists()) {
                ...
                if (FileLoader.getInstance(currentAccount).isLoadingFile(fileName)) {
                    ...
                    setUpdateText(LocaleController.getString(R.string.UpdateLumigram), animated);
                    showSize = true;
                }
            }

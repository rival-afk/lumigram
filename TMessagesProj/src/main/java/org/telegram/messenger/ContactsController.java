...
public class ContactsController extends BaseController {
    ...
    public String getInviteText(int contacts) {
        return LocaleController.formatString(R.string.InviteTextNeko, "https://github.com/rival-afk/lumigram");
    }
    ...
    public void checkAppAccount() {
        ...
        Utilities.globalQueue.postRunnable(() -> {
            ...
            try {
                Account[] accounts = am.getAccountsByType("com.lumigram.messenger");
            ...
            if (getUserConfig().isClientActivated()) {
                ...
                if (systemAccount == null) {
                    try {
                        systemAccount = new Account("" + getUserConfig().getClientUserId(), "com.lumigram.messenger");
...
//                });
    ...
    private void applyContactToPhoneBook(ArrayList<ContentProviderOperation> query, TLRPC.User user) {
        ...
        builder.withValue(ContactsContract.Data.MIMETYPE, "vnd.android.cursor.item/vnd.com.lumigram.messenger.android.profile");
        ...
        builder = ContentProviderOperation.newInsert(ContactsContract.Data.CONTENT_URI);
        builder.withValueBackReference(ContactsContract.Data.RAW_CONTACT_ID, rawContactId);
        builder.withValue(ContactsContract.Data.MIMETYPE, "vnd.android.cursor.item/vnd.com.lumigram.messenger.android.call");
        builder.withValue(ContactsContract.Data.DATA1, user.id);
        ...
        builder = ContentProviderOperation.newInsert(ContactsContract.Data.CONTENT_URI);
        builder.withValueBackReference(ContactsContract.Data.RAW_CONTACT_ID, rawContactId);
        builder.withValue(ContactsContract.Data.MIMETYPE, "vnd.android.cursor.item/vnd.com.lumigram.messenger.android.call.video");
        builder.withValue(ContactsContract.Data.DATA1, user.id);
